...
public class HttpClientWrapper {
	...
	private enum VERBTYPE {
         ...
         * @param urlEncoding
         * @param contentType
		 *@param httpClientWrapper @return
         * @throws HttpException
         * @throws IOException
         */
        public ResponseContent getResponse(String urlstr, String urlEncoding,
										   String contentType, HttpClientWrapper httpClientWrapper) throws HttpException,
                IOException {
    ...
    //				this.parseUrl(url);
                    ...
                    List<NameValuePair> nvBodyList = httpClientWrapper.getNVBodies();
